...
# Optional: use a specific Chromium binary instead of Playwright's managed one
# (e.g. a system Chromium in restricted environments).
CHROMIUM_EXECUTABLE_ENV = "S2C_CHROMIUM_EXECUTABLE"
    ...
    async def _get_browser(self) -> Browser:
        async with self._lock:
            if self._browser is None or not self._browser.is_connected():
                ...
                executable_path = os.environ.get(CHROMIUM_EXECUTABLE_ENV) or None
