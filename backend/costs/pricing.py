...
# Fallback pricing keyed by OpenRouter model slug. OpenRouter normally reports
# the exact USD cost of each call (usage.cost); this table is only used when
# that field is missing (e.g. BYOK endpoints) and for offline log summaries.
MODEL_PRICING: Dict[str, ModelPricing] = {
    ...
    "openai/gpt-5.4-2026-03-05": ModelPricing(
    ...
    "google/gemini-3.5-flash": ModelPricing(
