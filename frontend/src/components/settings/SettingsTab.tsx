            ...
            <div className="space-y-4 p-4">
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-zinc-400">
                  One key for every model (OpenAI, Anthropic, Gemini). Only stored
                  in your browser. Never stored on servers. Overrides your .env
                  config.
                </p>
                <Input
              ...
              {!IS_RUNNING_ON_CLOUD && (
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500 dark:text-zinc-400">
                    Optional. Only used for background removal (remove_backgrounds);
                    image generation and editing run through OpenRouter. Only stored
                    in your browser.
                  </p>
                  <Input
